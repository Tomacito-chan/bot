...
module.exports = {
    ...
    .addChannelOption(option => option.setName(`canal`).setDescription(`El canal donde se hara el sorteo.`).addChannelTypes(0).setRequired(true))
      ...
      if(interaction.options.getSubcommand() === "start"){
        ...
        client.giveawaysManager.start(canal, {
            ...
            messages: {
                ...
                winMessage: ganadores > 1 ? `🥳 | Enhorabuena {winners} habeis {this.prize}!` : `🥳 | Enhorabuena {winners} has ganado {this.prize}!`,
